...
class HomeDialogsHelper {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text('الإشعارات', style: TextStyle(fontSize: 20.sp, fontWeight: FontWeight.bold, color: AppColors.primaryDark, fontFamily: 'Cairo')),
                const Divider(),
                Expanded(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            leading: CircleAvatar(
                              ...
                              child: const Icon(Icons.notifications_active, color: AppColors.accentGold)
                            ), 
                            title: Text(notifItem['title'] ?? '', style: const TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Cairo')), 
                            subtitle: Text(notifItem['body'] ?? '', style: const TextStyle(fontFamily: 'Cairo')),
                          );
                        },
                      );
                    },
  ...
  static void showPasswordResetDialog(BuildContext pageContext, String phone, String email) {
    showDialog(
      context: pageContext, 
      builder: (ctx) => AlertDialog(
        ...
        title: Row(
          ...
          children: [
            const Icon(Icons.lock_reset_rounded, color: AppColors.primaryDark), 
            SizedBox(width: 8.w), 
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12.r), borderSide: const BorderSide(color: AppColors.royalGreen, width: 2))
          ),
        ), 
        actions: [
          TextButton(onPressed: () => Navigator.pop(ctx), child: const Text('إلغاء', style: TextStyle(fontFamily: 'Cairo', color: Colors.grey))), 
          ElevatedButton(
            style: ElevatedButton.styleFrom(backgroundColor: AppColors.royalGreen, foregroundColor: Colors.white), 
            onPressed: () { 
