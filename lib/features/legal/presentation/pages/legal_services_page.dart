...
class _LegalServicesPageState extends State<LegalServicesPage>
    ...
    if (await canLaunchUrl(launchUri)) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text('لا يمكن إجراء الاتصال حالياً ⚠️',
  ...
  final Map<String, Map<String, String>> _judgmentsData = {
    'نقض مدني': {
      'القصور في التسبيب وإغفال الدفاع':
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text('برجاء كتابة تفاصيل طلبك، وسيتم مراجعته بعناية.',
                      style: TextStyle(
                  ...
                  TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(Icons.person, color: goldAccent),
                          border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(12)),
                          focusedBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(12),
                              borderSide:
                                  BorderSide(color: primaryNavy, width: 2)))),
                  ...
                  TextField(
                      ...
                      maxLines: 4,
                      decoration: InputDecoration(
                          labelText: 'تفاصيل المشكلة أو الطلب',
                      ...
                      onPressed: () async {
                        if (nameController.text.isEmpty ||
                          ...
                          ScaffoldMessenger.of(sheetContext).showSnackBar(
                              const SnackBar(
                                  content: Text('برجاء ملء جميع الحقول! ⚠️',
                                      style: TextStyle(fontFamily: 'Cairo'))));
                          return;
                        }
                        ...
                        messenger.showSnackBar(SnackBar(
                            content: const Text(
                                'تم إرسال طلبك بنجاح! يمكنك المتابعة من "متابعة طلباتي" ⚖️',
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontFamily: 'Cairo')),
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return Center(
              child: Text('لا توجد طلبات موكلين حالياً ☕',
                  style: TextStyle(
                        ...
                        IconButton(
                          onPressed: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (_) =>
                                        LegalChatPage(requestId: doc.id)));
                          },
  ...
  Widget _buildClientView() {
    return Scaffold(
      appBar: AppBar(
        title: const Text('مكتب العدالة - بوابة العملاء',
        ...
        bottom: TabBar(
          ...
          tabs: const [
            Tab(icon: Icon(Icons.support_agent), text: 'الخدمات القانونية'),
            Tab(icon: Icon(Icons.track_changes), text: 'متابعة طلباتي')
          ],
        ),
      ),
            ...
            child: ConstrainedBox(
              ...
              child: ListView(
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 8),
                        const Text(
                            'نحن هنا لحماية حقوقك ومصالحك بكل احترافية وسرية تامة.',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                  ...
                  _buildServiceCard(
                      'طلب استشارة عاجلة',
                      'تواصل مع محامٍ متخصص فوراً',
                      Icons.chat_rounded,
                      () => _showServiceForm('طلب استشارة عاجلة')),
                  _buildServiceCard(
                      'صياغة ومراجعة العقود',
                      'بيع، إيجار، شراكة، وعمل',
                      Icons.edit_document,
                      () => _showServiceForm('طلب صياغة عقد')),
                  _buildServiceCard(
                      'تأسيس الشركات',
                      'إجراءات التراخيص والسجل التجاري',
                      Icons.business_center_rounded,
                      () => _showServiceForm('طلب تأسيس شركة')),
                  _buildServiceCard(
                      'حجز موعد بالمكتب',
                      'ترتيب زيارة لتبادل المستندات والتوكيلات',
                      Icons.calendar_month_rounded,
                      () => _showServiceForm('طلب حجز موعد')),
                  _buildServiceCard(
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => const LegalCalculatorsPage()));
                  }),
                ],
              ),
            ),
                          ...
                          Row(
                            ...
                            children: [
                              ElevatedButton.icon(
                                ...
                                onPressed: () =>
                                    _makePhoneCall(officePhoneNumber),
                              ...
                              ElevatedButton.icon(
                                ...
                                onPressed: () {
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (_) => LegalChatPage(
                                              requestId: doc.id)));
                                },
                                icon: const Icon(Icons.chat_bubble_outline),
                                label: const Text('رسالة للمحامي',
                                    style: TextStyle(fontFamily: 'Cairo')),
                              ),
                            ],
                          )
    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text(subtitle,
            style: TextStyle(
                color: Colors.grey.shade600, height: 1.5, fontFamily: 'Cairo')),
        trailing:
            Icon(Icons.arrow_forward_ios_rounded, color: goldAccent, size: 18),
        onTap: onTap,
      ),
    );
  }
            ...
            children: [
              Expanded(
                child: SingleChildScrollView(
                  child: Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: ProfessionalPetitionWidget(
                    ...
                    ElevatedButton.icon(
                      ...
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: const Text('تم النسخ بنجاح! 📋⚖️',
                                style: TextStyle(fontFamily: 'Cairo')),
                            backgroundColor: goldAccent));
                      },
  ...
  Widget _buildCategoryMenuButton(
        ...
        child: AnimatedContainer(
          ...
          child: Column(
            ...
            children: [
              Icon(icon,
                  size: 28,
                  color: isSelected ? goldAccent : Colors.grey.shade500),
              const SizedBox(height: 8),
              Text(
                name,
                style: TextStyle(
  ...
  Widget _buildLawyerSplitView(
      {required Map<String, Map<String, String>> fullData,
      required String activeCategory,
      required List<Widget> sideMenuButtons,
      bool isBooks = false}) {
    final currentCategoryData = fullData[activeCategory] ?? {};
    final filteredData = currentCategoryData.entries
        .where((entry) =>
            ...
            children: [
              Padding(
                ...
                child: TextField(
                  ...
                  textDirection: TextDirection.rtl,
                  decoration: InputDecoration(
                    hintText: 'ابحث في $activeCategory...',
              ...
              if (activeCategory == 'القضاء المدني' ||
                  activeCategory == 'محكمة الأسرة' ||
                  activeCategory == 'قضاء الجنايات والجنح' ||
                  activeCategory == 'مجلس الدولة')
                Column(
                  children: [
                    Padding(
                      padding: const EdgeInsets.symmetric(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 4),
                                    const Text(
                                        'أدخل بيانات أي قضية وولدها في ملف PDF',
                                        style: TextStyle(
                                            fontSize: 12,
                                            color: Colors.white70,
                                            fontFamily: 'Cairo')),
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (_) => const LawsuitArchivePage()));
                        },
                        borderRadius: BorderRadius.circular(12),
                        child: Container(
                          padding: const EdgeInsets.all(16),
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: const [
                                    ...
                                    SizedBox(height: 4),
                                    Text(
                                        'إدارة القضايا والملفات المحفوظة مسبقاً',
                                        style: TextStyle(
                                            fontSize: 12,
                                            color: Colors.white70,
                                            fontFamily: 'Cairo')),
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => const LegalLibraryPage()));
                    },
                    borderRadius: BorderRadius.circular(12),
                    child: Container(
                      padding: const EdgeInsets.all(16),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: const [
                                ...
                                SizedBox(height: 4),
                                Text(
                                    'تصفح وحمل المراجع وأكواد القوانين الرسمية',
                                    style: TextStyle(
                                        fontSize: 12,
                                        color: Colors.white70,
                                        fontFamily: 'Cairo')),
  ...
  Widget _buildLawyerView() {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('مكتب العدالة - الموسوعة والطلبات',
            style: TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Cairo')),
        backgroundColor: primaryNavy,
        foregroundColor: Colors.white,
        centerTitle: true,
      ...
      body: TabBarView(
        ...
        children: [
          ...
          _buildLawyerSplitView(
              fullData: _contractsData,
              activeCategory: _activeContractCategory,
              sideMenuButtons: [
                _buildCategoryMenuButton(
                    name: 'عقود البيع',
                    icon: Icons.storefront_rounded,
                    currentCategory: _activeContractCategory,
                    onSelected: (val) =>
                        setState(() => _activeContractCategory = val)),
                _buildCategoryMenuButton(
                    name: 'عقود الإيجار',
          ...
          _buildLawyerSplitView(
              fullData: _lawsuitsData,
              activeCategory: _activeLawsuitCategory,
              sideMenuButtons: [
                _buildCategoryMenuButton(
                    name: 'القضاء المدني',
                    icon: Icons.gavel_rounded,
                    currentCategory: _activeLawsuitCategory,
                    onSelected: (val) =>
                        setState(() => _activeLawsuitCategory = val)),
                _buildCategoryMenuButton(
                    name: 'محكمة الأسرة',
          ...
          _buildLawyerSplitView(
              fullData: _judgmentsData,
              activeCategory: _activeJudgmentCategory,
              sideMenuButtons: [
                _buildCategoryMenuButton(
                    name: 'نقض مدني',
                    icon: Icons.balance_rounded,
                    currentCategory: _activeJudgmentCategory,
                    onSelected: (val) =>
                        setState(() => _activeJudgmentCategory = val)),
                _buildCategoryMenuButton(
                    name: 'نقض جنائي',
                    icon: Icons.local_police_rounded,
                    currentCategory: _activeJudgmentCategory,
          ...
          _buildLawyerSplitView(
              fullData: _booksData,
              activeCategory: _activeBookCategory,
              isBooks: true,
              sideMenuButtons: [
                _buildCategoryMenuButton(
                    name: 'القانون المدني',
                    icon: Icons.book_rounded,
                    currentCategory: _activeBookCategory,
                    onSelected: (val) =>
                        setState(() => _activeBookCategory = val)),
                _buildCategoryMenuButton(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border(
                      right:
                          BorderSide(color: Colors.red.shade800, width: 2.5))),
              child: Column(
                children: [
                  const SizedBox(height: 24),
                  Container(
