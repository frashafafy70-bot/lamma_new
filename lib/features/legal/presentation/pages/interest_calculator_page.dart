                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                          'أدخل بريدك الإلكتروني المسجل وسنقوم بإرسال رابط مخصص لتغيير كلمة المرور فوراً',
                                ...
                                decoration: InputDecoration(
                                  ...
                                  focusedBorder: OutlineInputBorder(
                                      ...
                                      borderSide: BorderSide(
                                          color: goldAccent, width: 2)),
                                ),
                                validator: (value) {
                                  if (value == null || value.isEmpty)
                                    return 'برجاء إدخال البريد الإلكتروني أولاً';
                                  if (!value.contains('@'))
