...
class _LegalChatPageState extends State<LegalChatPage> {
  ...
  Future<void> _pickAndUploadImage() async {
    try {
      ...
      String fileName =
          'legal_chats/${widget.requestId}/${DateTime.now().millisecondsSinceEpoch}_${image.name}';
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text('حدث خطأ أثناء رفع المستند ⚠️',
  ...
  Future<void> _openAttachment(String url) async {
    ...
    if (await canLaunchUrl(launchUri)) {
      ...
      if (mounted)
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text('لا يمكن فتح هذا المرفق ⚠️',
                style: TextStyle(fontFamily: 'Cairo'))));
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('محادثة الاستشارة ⚖️',
          ...
          children: [
            if (_isUploading)
              LinearProgressIndicator(
                  color: goldAccent, backgroundColor: primaryNavy),
            Expanded(
                ...
                builder: (context, snapshot) {
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('ابدأ المحادثة الآن واطرح استفسارك..',
                              style: TextStyle(
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      bool hasImage = msg.containsKey('imageUrl') &&
                          msg['imageUrl'] != null;
                      bool hasText = msg.containsKey('text') &&
