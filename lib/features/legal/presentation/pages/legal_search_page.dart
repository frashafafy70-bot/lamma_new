...
class _LegalSearchPageState extends State<LegalSearchPage> {
  ...
  final List<Map<String, String>> _legalDatabase = [
    {'name': 'القانون المدني', 'url': 'https://www.cc.gov.eg/legislation_single?id=113063'},
    {'name': 'قانون العقوبات', 'url': 'https://www.cc.gov.eg/legislation_single?id=114878'},
    {'name': 'قانون الإجراءات الجنائية', 'url': 'https://www.cc.gov.eg/legislation_single?id=114881'},
    {'name': 'قانون التجارة', 'url': 'https://www.cc.gov.eg/legislation_single?id=113220'},
    {'name': 'قانون العمل', 'url': 'https://www.cc.gov.eg/legislation_single?id=113702'},
    {'name': 'قانون الأحوال الشخصية', 'url': 'https://www.cc.gov.eg/legislation_single?id=113303'},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('الباحث القانوني الذكي 🔍'), backgroundColor: const Color(0xFF0F172A)),
      body: Column(
        children: [
          Padding(
