...
// 🟢 الاستدعاءات الجديدة لصفحات التتبع
...
class _SmartTripCardState extends State<SmartTripCard> {
  ...
  void _showDeleteDialog(BuildContext context) {
    showDialog(
        ...
        builder: (ctx) => AlertDialog(
              ...
              title: Text('مسح الطلب',
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      color: Colors.red,
                      fontSize: 18.sp)),
              content: Text('هل أنت متأكد من إزالة هذا الطلب من القائمة عندك؟',
                ...
                ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      context
                          ...
                          .deleteTripFromList(widget.trip, widget.isDriver);
                    },
                    child: Text('نعم، امسح',
                        style:
  ...
  Widget build(BuildContext context) {
    ...
    bool isWaitingForOther =
        widget.trip.status == 'negotiating' && !isMyTurnToNegotiate;
    String displayPrice = widget.trip.finalPrice ??
        widget.trip.negotiationPrice ??
        widget.trip.price ??
        widget.trip.suggestedPrice ??
        'غير محدد';
        ...
        listener: (context, state) {
          if (state is TripActionsError) {
            ...
            if (state.action == 'accept') {
              ...
              // 🟢 التوجيه فوراً لشاشة التتبع حسب نوع المستخدم (كابتن أو عميل)
              if (widget.isDriver) {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) =>
                        DriverTripTrackingPage(tripId: widget.trip.id ?? ''),
                  ),
                );
              } else {
                Navigator.push(
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(
                              widget.trip.vehicleType == 'موتوسيكل'
                                  ? Icons.motorcycle
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildLocationRow(Icons.my_location, Colors.green,
                          'من : ', widget.trip.pickup ?? 'غير محدد'),
                      Padding(
                      ...
                      _buildLocationRow(Icons.location_on, Colors.red, 'إلى : ',
                          widget.trip.destination ?? 'غير محدد'),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 8.w),
                              Expanded(
                                child: Text('رسالة صوتية من العميل',
                                    style: TextStyle(
                        ...
                        if (widget.trip.status == 'pending') ...[
                          if (widget.isDriver) ...[
                            Row(
                              children: [
                                Expanded(
                                    child: _buildPriceInput('سعر عرضك...',
                                        _counterOfferController)),
                                SizedBox(width: 8.w),
                                ElevatedButton(
                                  style: ElevatedButton.styleFrom(
                            ...
                            Center(
                                child: Text('جاري البحث عن كباتن...',
                                    style: TextStyle(
                                        color: Colors.orange,
                                        fontSize: 14.sp,
                                        fontWeight: FontWeight.bold)))
                          ...
                          Row(
                            children: [
                              ...
                              if (widget.isDriver) ...[
                                SizedBox(width: 12.w),
                                Expanded(
                                    child: _buildActionButton('إنهاء الرحلة',
                                        primaryGreen, accentGold, () {})),
                              ]
                            ],
                          )
                        ],
  ...
  Widget _buildLocationRow(
      IconData icon, Color iconColor, String prefix, String text) {
    return Row(
      children: [
