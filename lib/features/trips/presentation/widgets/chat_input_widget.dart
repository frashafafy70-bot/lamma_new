...
class ChatInputWidget extends StatefulWidget {
  ...
  const ChatInputWidget(
      {super.key, required this.tripId, required this.currentUserId});
...
class _ChatInputWidgetState extends State<ChatInputWidget> {
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    if (pickedFile != null && mounted) {
      context
          .read<TripChatCubit>()
          .sendImageMessage(widget.tripId, File(pickedFile.path));
    }
  }
        ...
        builder: (innerContext) {
          return Padding(
            ...
            child: Container(
              ...
              padding: EdgeInsets.only(
                  top: 10.h, bottom: 20.h, left: 16.w, right: 16.w),
                      ...
                      _buildAttachmentOption(
                          ...
                          onTap: () {
                            ...
                            ScaffoldMessenger.of(innerContext).showSnackBar(
                                const SnackBar(
                                    content: Text('سيتم إرسال الموقع')));
                          }),
                      _buildAttachmentOption(
                          ...
                          onTap: () {
                            ...
                            ScaffoldMessenger.of(innerContext).showSnackBar(
                                const SnackBar(
                                    content: Text('سيتم فتح جهات الاتصال')));
                          }),
                    ],
                  ),
                ],
      ...
      children: [
        BlocBuilder<TripChatCubit, TripChatState>(
          builder: (context, state) {
            ...
            return Padding(
              padding:
                  EdgeInsets.only(left: 8.w, right: 8.w, top: 4.h, bottom: 8.h),
    ...
    return Row(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () {
            if (isTyping) {
              context.read<TripChatCubit>().sendMessage(
                  widget.tripId, widget.currentUserId, _messageController.text);
          ...
          child: CircleAvatar(
            ...
            child: Icon(isTyping ? Icons.send_rounded : Icons.mic,
                color: AppColors
                    .accentGold, // 🟢 إضافة لمسة ذهبية لأيقونة الإرسال والمايك
                size: 22.sp),
          ),
        )
      ],
        ...
        children: [
          IconButton(
            icon: Icon(Icons.delete_sweep_rounded,
                color: Colors.red.shade700, size: 26.sp),
          ...
          GestureDetector(
            onTap: () => context
                .read<TripChatCubit>()
                .stopRecordingAndSend(widget.tripId),
            child: CircleAvatar(
              radius: 20.r,
              backgroundColor: AppColors.royalGreen,
