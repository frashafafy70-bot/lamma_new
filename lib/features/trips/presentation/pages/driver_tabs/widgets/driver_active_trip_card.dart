...
class DriverActiveTripCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String finalPrice =
        (trip.finalPrice ?? trip.negotiationPrice ?? trip.price)?.toString() ??
            '0';
                ...
                children: [
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        ...
                        context
                            ...
                            .acceptOffer(trip, true, currentUserId);
                      },
                    ),
                  ),
                  SizedBox(width: 8.w),
                  Expanded(
                    child: ElevatedButton.icon(
                        ...
                        onPressed: () async {
                          final offer =
                              await TripDialogsHelper.showNegotiationDialog(
                            context: context,
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    context
                        ...
                        .activateDriverTripFunction(tripId);
                  },
                ),
              ),
              SizedBox(height: 12.h),
                ...
                Expanded(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                DriverTripTrackingPage(tripId: tripId))),
                  ),
                ),
              ],
            ),
