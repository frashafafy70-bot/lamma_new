      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            Expanded(
              // 🟢 الاستماع للـ TripActionsCubit هنا لإظهار الـ Loading Overlay بنجاح
                                                      ...
                                                      children: [
                                                        Expanded(
                                                          child: OutlinedButton.icon(
                                                            ...
                                                            // 🟢 تم استدعاء الـ Cubit مع الديالوج النظيف
                                                            onPressed: () async {
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: OutlinedButton.icon(
                                                      ...
                                                      onPressed: () async {
                                                        ...
                                                        if (result != null) {
                                                          // إذا قمت بعمل Cubit method لتعديل الرحلة المنشورة يمكن استدعاؤه هنا
                                                  ...
                                                  Expanded(
                                                    child: OutlinedButton.icon(
                                                      ...
                                                      // 🟢 الإلغاء باستخدام الكيوبت الجديد
                                                      onPressed: () async {
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: ElevatedButton.icon(
                                                      ...
                                                      // 🟢 إرسال التفاوض عبر الكيوبت الجديد
                                                      onPressed: () async {
