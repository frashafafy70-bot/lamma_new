...
class _PassengerRequestTabState extends State<PassengerRequestTab> {
  ...
  Future<void> _getUserLocation() async {
    ...
    try {
      // تم تعديل هذا السطر لحل مشكلة desiredAccuracy
            ...
            return Expanded(
              child: GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected ? royalGreen.withValues(alpha: 0.1) : Colors.white, // تم التعديل هنا
                    border: Border.all(color: isSelected ? royalGreen : Colors.grey.shade300, width: isSelected ? 2 : 1),
                    borderRadius: BorderRadius.circular(12),
                    boxShadow: isSelected ? [BoxShadow(color: royalGreen.withValues(alpha: 0.2), blurRadius: 8, offset: const Offset(0, 4))] : [], // تم التعديل هنا
                  ),
                  child: Column(
                    children: [
