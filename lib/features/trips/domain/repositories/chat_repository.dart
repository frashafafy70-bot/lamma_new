...
abstract class ChatRepository {
  ...
  Future<Map<String, String>> getOtherPartyInfo({required String tripId, required String currentUserId});
  Future<void> sendChatNotification({required String tripId, required String message});
}