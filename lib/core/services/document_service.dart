...
class DocumentService {
  ...
  static Future<bool> analyzeImageWithCloudVision(File imageFile, List<String> requiredKeywords) async { 
  ...
  static Future<String?> uploadDocumentToStorage({required String uid, required String role, required String docName, required File file}) async { 
    try { 
      Reference ref = FirebaseStorage.instance.ref().child('users/$uid/documents/$role/$docName.jpg'); 
